  ...
  $.fn.mauGallery.methods = {
    ...
    openLightBox(element, lightboxId) {
      ...
      if (modalElement) {
        ...
        $(modalElement).find(".lightboxImage").attr("src", element.attr("src"));
        modalInstance.show();
      } else {
    ...
    prevImage(lightboxId) {
      ...
      let imagesCollection = $("img.gallery-item:visible").toArray();
      let currentIndex = imagesCollection.findIndex(
        (img) => img === activeImage[0]
      );
      let prevIndex =
    ...
    filterByTag() {
      ...
      $(".gallery-item").each(function () {
        let parentColumn = $(this).parents(".item-column");
        parentColumn.hide();
